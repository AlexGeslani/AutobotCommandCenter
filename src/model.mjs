...
export const fixtures = {
  ...
  benchmarkComparison: [
    ...
    {
      conditionId: 'qwen38-2b-mlx', evidence: 'measured', note: 'IFEval and BFCL are final-verified for the exact 4-bit MLX/Metal condition. IFEval repeated exactly at 9 / 40 strict prompts and 47 / 95 instructions; BFCL scored 8.72% across the frozen 150-case selection after all 261 required rows were generated. tau2 Retail is complete at 25 / 25 and Telecom is active at 3 / 25 in the captured progress snapshot, so the tau2 primary score stays Pending rather than zero.',
      operational: {
        ...
        outcomes: [
          ...
          ['tau2 progress snapshot', '28 / 50 frozen tasks completed · Retail 25 / 25 · Telecom 3 / 25 active · score withheld as Pending'],
        ],
      ...
      scores: {
        ...
        agent: { label: 'Multi-turn agent', benchmark: 'tau2', value: null, evidence: 'pending', denominator: '28 / 50 live · score withheld', progress: { current: 28, total: 50, label: '28 / 50 frozen tasks · Retail 25 / 25 · Telecom 3 / 25', state: 'in-progress', capturedAt: '2026-08-28T00:34:06Z' }, detail: [['Frozen inventory', '25 Retail + 25 Telecom'], ['Completed simulations', 'Retail 25 / 25 · Telecom 3 / 25 · 28 / 50 total'], ['Harness errors', '0 observed in current progress artifact'], ['Current workload', 'Telecom active'], ['Scoring state', 'Pending full frozen inventory and final verification']] },
      },
    },
    {
      conditionId: 'qwen36-35b-heretic-gpu-b', evidence: 'measured', note: 'IFEval and BFCL are final-verified for the exact GPU Node B Qwen3.6 35B Heretic Q4_K_M MTP-N2 condition. BFCL scored 51.76% across 150 frozen scored cases after all 261 required rows were generated. tau2 Retail is complete at 25 / 25 and Telecom is active at 20 / 25 in the captured progress snapshot, so the tau2 primary score stays Pending rather than zero. Hardware identity beyond the retained public-safe host label and runtime/deployment geometry was not captured and is shown as unavailable rather than inferred.',
      operational: {
        evidence: 'verified-partial',
        candidateUsage: { inputTokens: 29773832, outputTokens: 4820327, totalTokens: 34594159, cachedInputTokens: null, reasoningTokens: null, retainedBridgeEvents: 2698, basis: 'Final-verified IFEval plus final-verified BFCL · incomplete tau2 usage excluded' },
        performance: {
        ...
        outcomes: [
          ...
          ['tau2 progress snapshot', '45 / 50 frozen tasks completed · Retail 25 / 25 · Telecom 20 / 25 active · score withheld as Pending'],
      ...
      scores: {
        ...
        agent: { label: 'Multi-turn agent', benchmark: 'tau2', value: null, evidence: 'pending', denominator: '45 / 50 live · score withheld', progress: { current: 45, total: 50, label: '45 / 50 frozen tasks · Retail 25 / 25 · Telecom 20 / 25', state: 'in-progress', capturedAt: '2026-08-28T00:40:09Z' }, detail: [['Frozen inventory', '25 Retail + 25 Telecom'], ['Completed simulations', 'Retail 25 / 25 · Telecom 20 / 25 · 45 / 50 total'], ['Current workload', 'Telecom active'], ['Scoring state', 'Pending full frozen inventory and final verification']] },
      },
    },
  ],
  results: [
