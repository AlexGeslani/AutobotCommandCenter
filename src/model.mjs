...
export const fixtures = {
  ...
  benchmarkComparison: [
    ...
    {
      conditionId: 'qwen38-2b-mlx', evidence: 'measured', note: 'IFEval and BFCL are final-verified for the exact 4-bit MLX/Metal condition. IFEval repeated exactly at 9 / 40 strict prompts and 47 / 95 instructions; BFCL scored 8.72% across the frozen 150-case selection after all 261 required rows were generated. tau2 Retail is complete at 25 / 25 and Telecom is active at 20 / 25 in the captured progress snapshot, so the tau2 primary score stays Pending rather than zero.',
      operational: {
    ...
    },
    {
      ...
      operational: {
        ...
        outcomes: [
          ...
          ['BFCL progress snapshot', '40 / 261 required generated rows persisted · collection active · score withheld'],
      ...
      scores: {
        ...
        tools: { label: 'Native tool use', benchmark: 'BFCL V4', value: null, evidence: 'pending', denominator: '40 / 261 generated · score withheld', progress: { current: 40, total: 261, label: '40 / 261 required generated rows · collection active', state: 'in-progress', capturedAt: '2026-08-28T11:43:16Z' }, detail: [['Frozen inventory', '261 required generated rows · 150 scored cases'], ['Completed generated rows', '40 / 261 persisted'], ['Current workload', 'BFCL collection active'], ['Scoring state', 'Pending collection and final verification']] },
