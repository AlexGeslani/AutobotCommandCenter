...
(() => {
  ...
  var TOP_FIELDS2 = /* @__PURE__ */ new Set(["schemaVersion", "dataKind", "generatedAt", "subject", "source", "versions", "coverage", "portfolio", "repositories"]);
  ...
  function projectGitHubAnalyticsProjection(value) {
    assertAllowedKeys3(value, TOP_FIELDS2, "projection");
    ...
    assertAllowedKeys3(value.source, SOURCE_FIELDS2, "source");
  ...
  function parseGitHubAnalyticsText(text) {
  ...
  function projectGitHubRepositoryOptions(projection) {
    return projection.repositories.map((repository) => ({
      id: repository.id,
      name: repository.name,
      retainedViews: repository.retainedTotals.views,
      retainedClones: repository.retainedTotals.clones,
      uniqueVisitors: repository.latestWindow.views.uniques,
      uniqueCloners: repository.latestWindow.clones.uniques
      ...
      return h(
        ...
        h(
          ...
          h("div", { className: "acc-github-repository-grid", role: "list" }, repositoryOptions.map((option) => h("button", {
            ...
            type: "button",
            role: "listitem",
            className: `acc-github-repository${option.id === repository.id ? " is-active" : ""}`,
          ...
          }, h("strong", null, option.name), h("span", null, `${formatNumber(option.retainedViews)} retained views \xB7 ${formatNumber(option.retainedClones)} retained clones`), h("small", null, `Latest window: ${formatNumber(option.uniqueVisitors)} unique visitors \xB7 ${formatNumber(option.uniqueCloners)} unique cloners`))))
        ),
        h(
          "section",
          { className: "acc-analytics-panel" },
  ...
  var ROUTE_KEYS = ["view", "q", "domain", "subject", "range", "repository", "mode", "product", "condition", "result", "release", "run", "evaluation"];
